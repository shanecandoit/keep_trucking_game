...
fn main() {
    App::new()
        ...
        .add_systems(Update, ui::capture_screen_pointer.before(update))
        .add_systems(Update, time_ui::update.before(update))
        .add_systems(Update, jobs::handle_input.after(update))
        .add_systems(Update, jobs::update_tablet.after(jobs::handle_input))
        .add_systems(Update, jobs::update_pois)
